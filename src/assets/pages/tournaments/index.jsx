    ...
    <section className="w-full flex flex-col justify-center h-auto items-center m-auto gap-y-10">
      <div className="w-[90%] h-auto py-20 flex flex-col justify-center items-center gap-y-7 ">
        ...
        <div className="flex justify-center items-center gap-4 mb-10">
          <button
            className={`py-2 px-4 rounded-lg ${filter === "All" ? "bg-green-500 text-white" : "bg-gray-200 text-black"}`}
          ...
          <button
            className={`py-2 px-4 rounded-lg ${filter === "masculino" ? "bg-green-500 text-white" : "bg-gray-200 text-black"}`}
            onClick={() => setFilter("masculino")}
          >
            Masculino
          </button>
          <button
            className={`py-2 px-4 rounded-lg ${filter === "mixed" ? "bg-green-500 text-white" : "bg-gray-200 text-black"}`}
