...
// import banner image 
import banner from '../../imgs/home/bannerSecondary2/image1.png'
...
const BannerSecondary2 = () => {
  return (
    <div className='h-[400px] w-full bg-cover bg-top bg-no-repeat  flex  flex-col justify-center items-start ' style={{backgroundImage:`url('${banner}')`}} > 
        ...
        <h4 className="h4 text-neutral-100 ">AFIBA CLASIC</h4>
        <p className=" w-[60%]  md:w-[40%] text-lg line-clamp-5  sm:line-clamp-none text-neutral-100 ">
          La liga mas grande de todas las ligas de nuestra federacion AFIBA Clasic es el rango mas alto de las competiciones
        </p>
