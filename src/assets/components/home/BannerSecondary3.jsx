  ...
  return (
    <div className="h-auto w-full flex flex-col md:flex-row justify-center items-center bg-gradient-to-t from-black to-green-900">
      ...
      <div className="w-full h-full flex justify-center items-center">
        <div
          className={`w-full h-[250px] overflow-hidden bg-cover bg-center bg-no-repeat transition-transform duration-300 cursor-pointer ${
        ...
        >
          {/* Optional: Add any additional content inside the image container */}
        </div>
      </div>
    </div>
  );
