...
const Hero = () => {
  ...
  return (
    <section className="h-auto w-full flex flex-col  text-neutral-100">
      <div className="bg-primary-300  w-full   h-[500px]  flex flex-col-reverse lg:flex-row justify-center items-center   ">
        ...
        {/* VIDEO */}
        <div className="w-full  lg:w-[60%] m-auto text-neutral-100 h-full   overflow-hidden  bg-red-500">
          <video className="h-full w-full scale-125" autoPlay muted loop>
            <source src={video} />
          </video>
        </div>
        {/* <Carrousel />*/}
