...
const Footer = () => {
 ...
 {   /*  <div className="flex justify-center items-center gap-10 py-5 font-semibold text-neutral-100  flex-wrap">
        <a
          href="#"
          className="hover:text-primary-400 text-[10px] sm:text-sm  transition-all duration-300 cursor-pointer"
        >
      ...
      <div className="flex justify-center items-center gap-10 text-[10px] pt-5   sm:text-s text-neutral-100 ">
