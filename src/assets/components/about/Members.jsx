      ...
      className="w-full h-[400px]  flex justify-center items-center">
        {MEMBERS.map((item, index) => (
          <div
            ...
            className="w-[300px] h-[350px] 0 rounded-2xl overflow-hidden  transition-all duration-300 hover:text-primary-100   hover:shadow-primary-100 hover:shadow-md  shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)]"
          >
            {/* Imagen */}
            <div
